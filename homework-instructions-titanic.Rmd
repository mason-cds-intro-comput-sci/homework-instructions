---
title: "Data Wrangling Homework: Titanic"
...
Use the R Markdown file `data_wrangling_homework.Rmd` to do your work and write-up when completing the questions below.
...
```{r titanic-photograph, echo = FALSE, fig.pos = "h", out.width = "35%", fig.cap="A photograph of the Titanic leaving Southampton on April 10, 1912.", results = "asis"}
knitr::include_graphics("img/titanic-photograph.jpg")

if(!knitr::is_latex_output()) {
  cat("<p>*A photograph of the Titanic leaving Southampton on April 10, 1912.*</p>")
}
```
...
6.  Give the *pull request* the following title: `Submission: Data Wrangling Homework, FirstName LastName`, replacing `FirstName` and `LastName` with your actual first and last name.
